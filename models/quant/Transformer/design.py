...
class Transformer(Design):
    def __init__(
        ...
        self._x_width = data_width
        self._y_width = data_width
        ...
        self._x_address_width = self.input_linear_design._x_addr_width
        self._y_address_width = self.output_linear_design._y_addr_width
    ...
    def save_to(self, destination: Path) -> None:
        ...
        template = InProjectTemplate(
            ...
            parameters=dict(
                ...
                input_linear_num_dimensions=str(
                    self.input_linear_design._num_dimensions
                ),
                input_linear_in_features=str(self.input_linear_design._in_features),
                input_linear_out_features=str(self.input_linear_design._out_features),
                gap_out_num_dimensions=str(self.avg_pooling_design._out_num_dimensions),
                gap_out_features=str(self.avg_pooling_design._out_features),
