...
class GetFirmware:
    def __init__(
        ...
        self._skeleton = Skeleton(
            ...
            x_addr_width=network_design._x_address_width,
            y_addr_width=network_design._y_address_width,
            x_data_width=network_design._x_width,
            y_data_width=network_design._y_width,
        )
    ...
    def _save_middleware_files(self, destination: Path) -> None:
        ...
        middleware_files = [f"env5_{name}" for name in middleware_files]
    ...
    def _save_top_files(self, destination: Path) -> None:
        file_names = ["env5_top_reconfig.vhd"]
